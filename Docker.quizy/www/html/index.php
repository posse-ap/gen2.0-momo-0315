<?php
    ...
    //画像をbig/questions tableから取得
    $questions = $dbh->prepare('SELECT * FROM big_questions WHERE id=?');
    $questions->execute(array($_REQUEST['id']));
    $questions_result = $questions->fetch();
?>
...
<head>
    ...
    <title>ガチで東京の人しか解けない！<?php echo $questions_result['name']; ?></title>
        ...
        <div class="content-wrapper">
            ...
            <h4>
                ...
                <a href="https://kuizy.net/">
                    <svg width="50px" height="86px" viewBox="0 0 228 86" version="1.1"
            ...
            <li>
                <a href="https://kuizy.net/quiz">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="#30619C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<div class="container content-wrapper">
    ...
    <?php foreach ($options_result as $options_result){
        //phpのシャッフル、１・２・３がシャッフルされる
        $shuffle_num = [1,2,3];
        shuffle($shuffle_num);
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="answerBox" id="answerBox_<?php  print($options_result['question_id']) ?>_0">
                ...
                <p class="description">正解は「<?php print($options_result['option_1']);?>」です！</p>
            </div>
            <div class="answerBox" id="answerBox_<?php  print($options_result['question_id']) ?>">
